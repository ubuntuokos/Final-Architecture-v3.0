...
- `FA3-PROVIDER-MINIMAX-H3-001`: **retired reference-only provider record**. Direct dependency, provider selection and runtime execution are forbidden; any H3-like requirement must use `FA3-H3-REPLACEMENT-001` through the provider-neutral FA3 video generation fabric.
