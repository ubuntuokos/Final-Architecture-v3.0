...
This directory materializes the optional SillyTavern Linux desktop client projection with KDE/Wayland as the reference path and X11 compatibility preserved.
...
- Wayland is preferred; X11 is a supported compatibility session.
