...
install -d -o fa3-step-ca -g fa3-step-ca -m0700 /var/lib/fa3-step-ca/{certs,secrets,db,evidence}; install -d -m0755 /etc/fa3/step-ca; install -d -m0700 /etc/fa3/secrets
