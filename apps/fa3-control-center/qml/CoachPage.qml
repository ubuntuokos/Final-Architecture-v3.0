...
ScrollView {
    ...
    ColumnLayout {
        ...
        Column {
            ...
            Label {
                width: parent.width
                text: root.t("Célok, fókusz, blockerek, következő legjobb lépés és végrehajtási fejlődés.", "Goals, focus, blockers, next-best actions and execution progress.")
        ...
        Card {
            ...
            Layout.leftMargin: 24
            Layout.rightMargin: 24
            Layout.preferredHeight: Math.round(255 * root.uiScale)
            ...
            GridLayout {
                ...
                ComboBox {
                    model: ["Silent", "Advisory", "Balanced", "Proactive", "Strict"]
                    currentIndex: ["Silent", "Advisory", "Balanced", "Proactive", "Strict"].indexOf(root.settings.value("coach/intervention", "Balanced"))
                    onActivated: root.settings.setValue("coach/intervention", currentText)
                }
            }
        }
        ...
        RowLayout {
            ...
            Card {
                ...
                ColumnLayout {
                    ...
                    Label {
                        text: "Progress & Intervention"
                        font.bold: true
                        font.pixelSize: root.px(16)
                    }

                    CheckBox {
                        text: root.t("Rendszeres check-in", "Regular check-ins")
                        checked: root.settings.value("coach/checkIns", true)
                        onToggled: root.settings.setValue("coach/checkIns", checked)
                    }

                    CheckBox {
                        text: root.t("Projekt-awareness", "Project awareness")
                        checked: root.settings.value("coach/projectAwareness", true)
                        onToggled: root.settings.setValue("coach/projectAwareness", checked)
                    }

                    CheckBox {
                        text: root.t("Heti review", "Weekly review")
                        checked: root.settings.value("coach/weeklyReview", true)
                        onToggled: root.settings.setValue("coach/weeklyReview", checked)
                    }

                    TextField {
                        Layout.fillWidth: true
                        placeholderText: "Quiet hours"
                        text: root.settings.value("coach/quietHours", "20:00-08:00")
                        onEditingFinished: root.settings.setValue("coach/quietHours", text)
                    }
                }
            }
            ...
            Card {
                ...
                ColumnLayout {
                    ...
                    CheckBox {
                        text: root.t("Mentor referral engedélyezve", "Allow Mentor referrals")
        ...
        Card {
            ...
            Layout.leftMargin: 24
            Layout.rightMargin: 24
            Layout.preferredHeight: Math.round(185 * root.uiScale)
            ...
            ColumnLayout {
                ...
                Label {
                    text: "FA3-COACH-001 — advisory projection; runtime authority remains external."
                    color: root.accent
                }
            }
        }
