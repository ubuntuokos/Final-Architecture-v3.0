...
Item {
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            Label {
                text: "Credential-tokenek és AI-fogyasztási tokenek közös, provider-semleges governance felülete. Machine/service secret delivery: FA3-SECRET-BROKER-001; raw secret value nem jelenik meg a GUI-ban."
                ...
                ScrollView {
                    ...
                    StackLayout {
                        ...
                        ColumnLayout {
                            ...
                            InfoLine { titleText: "Secret runtime"; detailText: "FA3-SECRET-BROKER-001 materialized · machine/service vault: separate LUKS2 image · production promotion requires real current-host E2E."; tone: root.green }\n                            InfoLine { titleText: "Usage telemetry"; detailText: "Valós tokenhasználat/költség továbbra is N/A, amíg admitted telemetry adapter nincs."; tone: root.textMuted }
                        ...
                        ColumnLayout {
                            ...
                            InfoLine { titleText: "Security boundary"; detailText: "Raw machine/service secret a külön titkosított machine-state image-ben marad; nem kerülhet QSettings-be, Session Vault raw credential könyvtárba, repository configba, logba, telemetry-be vagy Evidence-be."; tone: root.magenta }
