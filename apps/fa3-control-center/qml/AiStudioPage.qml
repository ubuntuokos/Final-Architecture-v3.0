...
Item {
    ...
    property var modules: [
        ...
        {title: "Music", badge: "ACE-STEP · EVIDENCE PENDING", tone: root.magenta, summary: "ACE-Step 1.5 provider-projekció, stems, DAW és mastering workflow-k a központi Model Router és HRB határai mögött.", actions: ["ACE-Step generation · provider status / model discovery", "Text2Music · Remix · Repaint · Cover · Extract / Lego", "Stem separation", "DAW handoff · natív projektfájlok megőrzése", "Lossless WAV/FLAC master + provenance", "Current-host promotion: PENDING"]},
