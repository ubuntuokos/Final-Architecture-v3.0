...
def gate(root):
    root=root.resolve();f=[];required=["canonical/providers/FA3-PROVIDER-BROWSER-CDP-001.json","canonical/browser-cdp-current-host-enforcement.json","src/fa3_browser_cdp_provider.py","src/fa3_browser_cdp_current_host_gate.py","tests/test_browser_cdp_provider.py"]
    for rel in required:
