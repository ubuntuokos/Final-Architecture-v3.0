...
def gate(root: Path) -> dict[str, Any]:
    ...
    require("AE-011", docs["p3d_oci"].get("production_status") == "PENDING_CURRENT_HOST" and docs["p3d_oci"].get("production_promotion_claimed") is False, "PyTorch3D OCI may not synthesize production admission")
    ...
    require("AE-015", "ARG BUILDER_BASE" in containerfile and "ARG RUNTIME_BASE" in containerfile and "0a7d4c1a171e8b768c63f15b17564f9ad495f49b" in containerfile and "conda" not in containerfile.lower(), "PyTorch3D container source build policy drift")
