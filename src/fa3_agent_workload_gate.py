...
def gate(root: Path) -> dict[str, Any]:
    ...
    ax_bridge_schema,ax_bridge_intent,ax_bridge_reuse,ax_runner_schema=[load(paths[k]) for k in ("ax_bridge_schema","ax_bridge_intent","ax_bridge_reuse","ax_runner_schema")]
