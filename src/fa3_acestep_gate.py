...
P0_INVARIANTS = [
    ...
    "VENDOR_NEUTRAL_HARDWARE_BASELINE_REQUIRED",
    "MODEL_ROUTER_IS_SINGLE_PROVIDER_SELECTION_AUTHORITY",
    "NO_FIXED_PRIVATE_PROVIDER_ROUTE",
    "SOFTWARE_COEXISTENCE_AND_HOST_NON_INTERFERENCE_REQUIRED",
    "ACE_STEP_GUI_IS_WORKSPACE_PROJECTION_NOT_NEW_AUTHORITY",
    "XL_SFT_COVER_RENOISE_RISK_BLOCKS_AFFECTED_PROMOTION",
]
