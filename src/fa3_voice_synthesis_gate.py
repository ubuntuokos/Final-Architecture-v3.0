...
def run_conformance(root: Path) -> dict[str, Any]:
    ...
    check("VOICE-020", any("VOICE_CLONING" in item for item in consent_rules) and {"issuer_ref", "jurisdiction", "legal_basis_ref", "signature_ref"}.issubset(consent_required), "typed, issued and signed cloning consent")
