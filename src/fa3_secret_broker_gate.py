...
def check()->dict:
    ...
    req(e.get("fail_closed") is True and e.get("mandatory_rule_count")==38 and len(e.get("p0_invariants",[]))==38,"SB-012")
    req("PODMAN_SECRET_TYPE_ENV_FORBIDDEN_BY_DEFAULT" in e["p0_invariants"] and "REAL_CURRENT_HOST_E2E_REQUIRED_FOR_RUNTIME_PROMOTION" in e["p0_invariants"] and "INFISICAL_TARGETED_GET_ONLY_BULK_EXPORT_FORBIDDEN" in e["p0_invariants"] and "PODMAN_SECRET_STORE_RAM_ONLY_CLAIM_REQUIRES_EVIDENCE" in e["p0_invariants"],"SB-013")
