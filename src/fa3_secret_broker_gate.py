...
def check()->dict:
    ...
    req("policy-check" in admin and "policy-install" in admin and "rotate" in admin and "revoke" in admin and "backup" in admin and "restore" in admin and "assert-closed" in admin,"SB-023E")
    ...
    req("/usr/local/bin/fa3-secrets-admin" in installer and "/usr/local/sbin/fa3-secret-vault-recovery" in installer and "/usr/local/sbin/fa3-secret-policyctl" in installer,"SB-023H")
