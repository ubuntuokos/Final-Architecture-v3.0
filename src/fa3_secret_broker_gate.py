...
def check()->dict:
    ...
    req(operations.get("entrypoint")=="/usr/local/bin/fa3-secrets-admin" and set(operations.get("credential_store",[]))=={"put","rotate","revoke","metadata","list"} and set(operations.get("recovery",[]))=={"backup","restore"} and operations.get("bulk_secret_export")=="FORBIDDEN","SB-023C")
    ...
    req("policy-install" in admin and "rotate" in admin and "revoke" in admin and "backup" in admin and "restore" in admin and "assert-closed" in admin,"SB-023E")
