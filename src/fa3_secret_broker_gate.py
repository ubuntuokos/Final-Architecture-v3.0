...
def check()->dict:
    ...
    req("exportable must be false" in policyctl and "machine/service secret requires exactly one dedicated non-root consumer user" in policyctl and '"check"' in policyctl,"SB-023F")
