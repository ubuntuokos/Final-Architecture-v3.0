...
def static_check(root:Path):
    ...
    if modernization_integration_ref["result"]!="PASS":
        fs.append(finding("FA3-STATIC-134","Modernization integration authority/evidence boundary gate failed",modernization_integration_gate=modernization_integration_ref))
