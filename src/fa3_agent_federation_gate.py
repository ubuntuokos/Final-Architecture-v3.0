...
def gate(root: Path) -> dict[str, Any]:
    ...
    checks=[
      ...
      (g.get("id")==GATE_ID and g.get("gateset_id")==GATESET_ID and g.get("regression_case_count")==14 and g.get("cross_host_runtime_evidence") is False,"FED-019","gate record drift"),
      (GATESET_ID in set(pol.get("mandatory_reference_gates",[])) and pol.get("agent_federation_profile_id")==PROFILE_ID and pol.get("agent_federation_contract_id")==CONTRACT_ID,"FED-020","global enforcement binding missing"),
