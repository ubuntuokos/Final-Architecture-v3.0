...
class SecretBrokerTests(unittest.TestCase):
    def test_store_rotation_and_permissions(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            m1=s.put("provider/api","alpha".encode(),"MACHINE_SERVICE_SECRET")
            m2=s.put("provider/api","beta".encode(),"MACHINE_SERVICE_SECRET")
    ...
    def test_policy_authorization_and_audit_redaction(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            broker.store.put("github/token",b"TOP-SECRET-CANARY","MACHINE_SERVICE_SECRET")
            user=pwd.getpwuid(os.getuid()).pw_name
            policy={"schema":"fa3.secret-projection-policy.v1","secret_id":"github/token","classification":"MACHINE_SERVICE_SECRET",
    ...
    def test_invalid_secret_id_rejected(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaises(ValueError):s.put("../../escape",b"x","MACHINE_SERVICE_SECRET")
