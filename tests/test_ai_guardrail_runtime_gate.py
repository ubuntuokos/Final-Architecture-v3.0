...
class AIGuardrailRuntimeGateTests(unittest.TestCase):
    ...
    def test_model_backed_multiworker_requires_evidence(self):
        self.assertTrue(concurrency_valid(
            worker_count=1,
            model_backed=True,
            shared_model_proven=False,
            benchmark_pass=False,
            memory_budget_pass=False,
        ))
        ...
        self.assertTrue(concurrency_valid(
            worker_count=2,
            model_backed=True,
            shared_model_proven=True,
            benchmark_pass=True,
            memory_budget_pass=True,
        ))
