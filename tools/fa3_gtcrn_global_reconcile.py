...
CONTRACT_ID = "FA3-SPEECH-ENHANCEMENT-CONTRACTS-001"
DECISION_ID = "FA3-DEC-GTCRN-SPEECH-ENHANCEMENT-2026-09-09"
GATE_ID = "FA3-GTCRN-GATESET-001"
CAPABILITY_ID = "CAP-017"
CAPABILITY_COUNT = 143
REFERENCE_EVIDENCE = "evidence/reference/gtcrn-reference-pass.json"
REGISTRY = "evidence/evidence-registry.json"
RELEASE = common.RELEASE
TEMP_WORKFLOW = ".github/workflows/fa3-gtcrn-reconcile-once.yml"
...
def patch_registry() -> None:
    ...
    cap["gtcrn_speech_enhancement_projection_status"] = {
        ...
        "current_host_runtime_evidence": "PENDING_REAL_ONNX_AUDIO_E2E_QUALITY_AND_ROLLBACK",
        "pipewire_ladspa_status": "OPTIONAL_EXPERIMENTAL_NOT_REQUIRED_WHEN_DISABLED",
...
def patch_release_semantics() -> None:
    ...
    release.setdefault("evidence_registry", {})["gtcrn_capability_binding"] = {
    ...
    release["gtcrn_reconciliation"] = {
        ...
        "classification": "OPTIONAL_CPU_FIRST_ONNX_REALTIME_SPEECH_ENHANCEMENT_REFERENCE_PROVIDER",
    ...
    note = (
        "FA3-PROVIDER-GTCRN-001 is globally reconciled to CAP-017 / "
        "FA3-SPEECH-ENHANCEMENT-001 as an optional CPU-first ONNX real-time speech "
        "enhancement provider. Reference gate PASS does not promote current-host runtime; "
        "quarantine SHA-256, real ONNX audio E2E quality, RTF and rollback evidence remain required."
    )
...
def projection_only(snapshot_head: str) -> None:
    ...
    verification["gtcrn_reconciliation_generator"] = "tools/fa3_gtcrn_global_reconcile.py"
    verification["gtcrn_deterministic_regeneration_pass"] = True
    verification["gtcrn_snapshot_head"] = snapshot_head
    write(RELEASE, release)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="GTCRN evidence-registry and unified release reconciliation")
